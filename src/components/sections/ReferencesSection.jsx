  ...
  return (
    ...
    >
      ...
      <div className="card">
        ...
        <h4>Robin Nelson - <em>Practice as Research in the Arts: Principles, Protocols, Pedagogies, Resistances</em> (2013)</h4>
        <p>
        ...
        <h4>Donald Schön - <em>The Reflective Practitioner: How Professionals Think in Action</em> (1983)</h4>
        <p>
        ...
        <h4>Estelle Barrett & Barbara Bolt - <em>Practice as Research: Approaches to Creative Arts Enquiry</em> (2010)</h4>
        <p>
